...
Um "bad seed" é quando um gerador de números pseudoaleatórios (PRNG) é inicializad com uma semente previsível ou insuficientemente aleatória, permitindo que todos os números gerados possam ser previstos. 
